...
import {
  ...
  handleAmount,
  handleSubmit,
} from "../redux/forms/formActions";
import store from "../redux/store";
import rootReducer from "../redux/rootReducer";
import formReducer from "./../redux/forms/formReducer";
...
const mapDispatchToProps = (dispatch) => ({
  ...
  handleSubmit: (everywhere, charge, amount) =>
    dispatch(handleSubmit(everywhere, charge, amount)),
});
